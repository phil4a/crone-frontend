			...
			<div className="container">
				<div className="flex flex-col md:gap-10 xl:flex-row xl:gap-5">
					<div className="xl:w-1/2 mb-7 md:mb-0">
						<Title as="h2" variant="h2" className="mb-6 md:mb-7.5">
							Остались вопросы?
						</Title>
					...
					<form onSubmit={handleSubmit(onSubmit)} className="flex-1 flex flex-col gap-4 md:gap-5">
						<div>
							<Input
								label="Имя*"
								placeholder="Имя*"
						...
						<Button type="submit" disabled={isSubmitting} className="mt-2 md:mt-2.5 md:w-55">
